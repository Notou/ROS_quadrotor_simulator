...
namespace quad_control {
  ...
  std::vector<quad_control::WaypointWithTime> WaypointWithTime::Read_waypoints(std::vector<quad_control::WaypointWithTime> waypoints){
    ...
    std::ifstream wp_file("/home/stef/catkin_ws/src/ROS_quadrotor_simulator/quad_control/resource/wg_waypoints.txt");
    //wg_waypoints.txt  kitchen_waypoints.txt kitchen_short_waypoints
